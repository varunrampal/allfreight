...
import ContactusImage from '../assets/images/hero_123.jpg'
  ...
  return (
     <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-7">
            <p><img src={ContactusImage} alt="Image" class="img-fluid"/></p>
          </div>
          <div class="col-md-5">
            <span class="text-serif text-primary">Book Now</span>
            <h3 class="heading-92913 text-black">Book A Freight</h3>
